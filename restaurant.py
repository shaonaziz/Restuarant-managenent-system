...
def Ref():
    ...
    CostofMeal= "BDT", str('%.2f' % (CostofFries+CostofDrinks+CostofNoodles+CostofSoup+CostBurger+CostSandwich))
    ...
    Service = "BDT", str ('%.2f' % Ser_Charge)

    OverAllCost ="BDT", str ('%.2f' % (PayTax+TotalCost+Ser_Charge))
